...
class VaccinationService {
    ...
    static calculateAgeInDays(birthDate) {
        const birth = new Date(birthDate);
        const today = new Date();
    ...
    static calculateAgeInYears(birthDate) {
        const birth = new Date(birthDate);
        const today = new Date();
    ...
    static async getFullSchedule(childId) {
        const db = getDB();
    ...
    static getAgeDescription(age_value, age_unit) {
        switch(age_unit) {
